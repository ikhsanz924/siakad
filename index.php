  ...
  if (isset($_SESSION[id])){
      if ($_SESSION[level]=='superuser'){
        ...
        $iden = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM users where id_user='$_SESSION[id]'"));
          $gu = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM guru where nip='$iden[username]'"));
         $nama =  $iden[nama_lengkap];
         $level = 'Lembaga Sertifikasi Profesi';
         if (trim($gu[foto])==''){
            $foto = 'foto_siswa/no-image.jpg';
         }else{
            $foto = 'foto_pegawai/'.$gu[foto];
      ...
      <aside class="main-sidebar">
            <?php 
              if ($_SESSION[level]=='siswa'){
                ...
                include "menu-manmutu.php";
              }elseif ($_SESSION[level]=='subrayon'){
                include "menu-subrayon.php";
              }elseif ($_SESSION[level]=='kepala'){
                include "menu-kepsek.php";
              }elseif ($_SESSION[level]=='humas'){
                include "menu-humas.php";
              }elseif ($_SESSION[level]=='bkk'){
                include "menu-bkk.php";
              }elseif ($_SESSION[level]=='kesiswaan'){
                include "menu-kesiswaan.php";
              }elseif ($_SESSION[level]=='lsp'){
                include "menu-lsp.php";
              }elseif ($_SESSION[level]=='keuangan'){
      ...
      <div class="content-wrapper">
        ...
        <?php 
          ...
          elseif ($_GET[view]=='pengembalian'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_pengembalianbarang.php";
            echo "</div>";
          }
           elseif ($_GET[view]=='test'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_test.php";
            echo "</div>";
          }
