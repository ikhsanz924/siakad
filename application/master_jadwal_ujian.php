                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-success btn-xs' title='Edit Data' href='?view=jadwalujian&act=editjadwalujian&id=$r[id]'><span class='glyphicon glyphicon-edit'></span></a>
  ...
  if (isset($_POST[tambah])){
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['ax']['tmp_name'], $uploadfile)) {
          mysqli_query($koneksi,"INSERT INTO jadwal_ujian(nm_ujian, semester, tahun) VALUES('$filenamee','$_POST[ab]','$_POST[ac]')");
          }
      }else{
