            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Nilai UKK DUDI </h3>
                  <?php if($_SESSION[level]!='kepala'){ ?>
                  <a class='pull-right btn btn-primary btn-sm' href='index.php?view=nilaiukkdudi&act=tambah'>Tambahkan Data</a>
                  <?php } ?>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                   $tampil = mysqli_query($koneksi,"SELECT * FROM nilai_ukk_dudi");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='?view=nilaiukkdudi&act=edit&id=$r[id]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='?view=nilaiukkdudi&hapus=$r[id]'><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                              }
                            echo "</tr>";
                      $no++;
                      ...
                      if (isset($_GET[hapus])){
                          mysqli_query($koneksi,"DELETE FROM nilai_ukk_dudi where id='$_GET[hapus]'");
                          echo "<script>document.location='index.php?view=nilaiukkdudi';</script>";
                      }
...
<?php 
    ...
    if (isset($_POST[update])){
        mysqli_query($koneksi,"UPDATE nilai_ukk_dudi SET kelas = '$_POST[a]',
                                         instansi = '$_POST[b]',
                                         nilai = '$_POST[c]',
                                         keterangan = '$_POST[d]'
                                         where id='$_POST[id]'");
    ...
    $edit = mysqli_query($koneksi,"SELECT * FROM nilai_ukk_dudi where id='$_GET[id]'");
    $s = mysqli_fetch_array($edit);
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Data Nilai UKK DUDI</h3>
                </div>
              <div class='box-body'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=nilaiukkdudi'><button class='btn btn-default pull-right'>Cancel</button></a>
                  </div>
              </form>
            </div>";
    ...
    if (isset($_POST[tambah])){
      ...
      $nama = mysqli_fetch_array($tambahnama);
        mysqli_query($koneksi,"INSERT INTO nilai_ukk_dudi(nisn, nama, kelas, instansi, nilai, keterangan) VALUES('$_POST[a]','$nama[nama]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]')");
        echo "<script>document.location='index.php?view=nilaiukkdudi';</script>";
    }
